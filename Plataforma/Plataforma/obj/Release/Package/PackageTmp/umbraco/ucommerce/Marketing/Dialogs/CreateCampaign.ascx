...
<asp:CustomValidator runat="server" OnServerValidate="ValidateCampaignName" ErrorMessage="The name is already in use." CssClass="validationMessage" Display="Dynamic" Width="100%" />
