                    ...
                    function () {
                    	...
                    	if (alert.length == 0) {
                    		...
                    		alert = $('<div />', {
                    			...
                    			html: '<button type="button" class="close" data-dismiss="alert">×</button><p>Gracias, el item fue agregado a tu carrito de compras. <a href="/basket">Click aqui para ver tu carrito</a>.</p>'
                    		}).hide();
                    		parent.append(alert);
                    		alert.slideDown();
                    	} else {
