...
<table>
	<tr>
		...
		<td>
			...
			<asp:RegularExpressionValidator meta:ResourceKey="NameValidator" ID="NameValidator" ControlToValidate="NameTextBox" CssClass="validationMessage" ValidationExpression="^(?!(xml|[_\d\W]))[^ \s\W]+$" ErrorMessage="Name can contain only letters and numbers(*)." Display="Dynamic" runat="server" />
