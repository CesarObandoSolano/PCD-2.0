    ...
    <div>
        <div class="propertyItem">
            ...
            <div class="propertyItemContent">
                <asp:TextBox runat="server" ID="ValueTextBox" Text="<%# QueryString.Common.IsNew ? QueryString.Common.Name : View.DataTypeEnum.Value %>" cssclass="mediumWidth entityName"/>
                ...
                <asp:RegularExpressionValidator runat="server" ControlToValidate="ValueTextBox" Display="Dynamic" Enabled="<%# !string.IsNullOrEmpty(View.DataType.ValidationExpression) %>" ValidationExpression="<%# View.DataType.ValidationExpression %>" Text="*" ErrorMessage='<%# GetLocalResourceObject("Value.Text") %>' CssClass="validator" />
